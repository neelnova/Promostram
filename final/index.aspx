<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="final.WebForm1" %>
...
<html lang="zxx">
<head>
<title>Photostat a Photo Gallery Category Flat Bootstrap Responsive Website Template | Home :: w3layouts</title>
<!-- custom-theme -->
				...
				<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
					<nav class="menu menu--iris">
						<ul class="nav navbar-nav menu__list">
                            ...
                            <li class="menu__item"><a href="login.aspx" class="btnlog"  >Login</a></li>
                              <li class="menu__item"><a href="reg.aspx" class="btnlog">Registration</a></li>
	...
	<div class="banner-bottom jarallax" id="services">
		   <div class="agile_overlay">
			...
			<div class="agileits_heading_section">
				<h3 class="wthree_head two">WHAT WE HAVE</h3>
...
<div class="gallery" id="gallery">
	 <div class="agileits_heading_section">
				<h3 class="wthree_head">Happy Users</h3>
				<p class="w3l_sub_para_agile">Through This intermediate</p>
			</div>
			<div class="inner_w3l_agile_grids">
...
<script type="text/javascript" src="js/bootstrap-3.1.1.min.js"></scrip>
</body>  
</html>
