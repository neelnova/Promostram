...
<head>
    ...
    <link href="css/aos-animation.css" rel="stylesheet" media="all"/>
    <!-- owl carousel -->
...
<body>
    ...
    <section class="content-main-w3" id="home">
        ...
        <div class="header_top_w3ls">
            <nav class="navbar navbar-expand-lg navbar-light bg-light" >
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                     <ul class="navbar-nav mx-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="reg.aspx">Register</a>
                        </li>
            ...
            <div class="logo-wthree text-center">
                <a class="navbar-brand" href="Default.aspx">
				 P R O M O S T R E A M <span> Make Memories</span></a>
            </div>
        ...
        <div class="container-fluid gallery-lightbox my-5">
            ...
            <div class="about" >
            <section class="banner-bottom-w3layouts py-lg-5 py-md-5 py-3" id="about" >
            <div class="container">
            <div class="inner-sec-w3ls py-lg-5 py-3">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 about-right mt-lg-4" data-aos="flip-left">
                        ...
                        <h3 class="tittle text-uppercase">Providing the service of intermediator.</h3>
                        <p class="my-4">You  can find Photographer here for your portfolio, for wedding, for any type of events, for birthday party, you can also find a model(Fashion blogger) for your products like clothes, for socialmedia page purpose. it will reduce your work if you are a photographer,fashion blogger or a Advertiser, just create a account and make your work easy.</p>
                    </div>
                </div>
                </div>
               </div>
    ...
    <section class="banner-bottom-w3layouts pt-lg-5 pt-md-3 pt-3" id="contact">
                    ...
                    <div class="col-lg-4 address-grid-w3ls">
                        <div class="row address-info" data-aos="fade-up">
                            ...
                            <div class="col-md-9 address-right text-left">
                                ...
                                <p>Email :
                                    <a href="#"> Promostream@gmail.com</a>
                                </p>
                            </div>
                        ...
                        <div class="form">
                            ...
                            <form action="#" method="post" >
                                ...
                                <div class="form-group">
                                    ...
                                    <asp:TextBox ID="email" CssClass="form-control" required="" runat="server"></asp:TextBox>
                                    
                                </div>
                                <div class="form-group">
                                    <label>Message</label>
                                    <asp:TextBox runat="server" ID="textarea" placeholder="" TextMode="MultiLine"></asp:TextBox>
                                </div>
                                <div class="input-group1">
                                    <asp:Button runat="server" CssClass="form-control" ID="submit" Text="Submit"  />
                                </div>
                            </form>
                        </div>
                    </div>
        ...
        <!--/footer-->
        <section style="background-color:chocolate;padding-bottom:30px;">
        <footer class="mt-lg-5 mt-3" >
           ...
           <ul class="social-icons justify-content-center mt-md-5 mt-3">
            ...
            <p class="copy-right-w3ls my-3">© 2018 Promostream. All rights reserved | Design by <a href="#">Promostream</a></p>
        </div>
        </footer>
    </section>
    </form>
